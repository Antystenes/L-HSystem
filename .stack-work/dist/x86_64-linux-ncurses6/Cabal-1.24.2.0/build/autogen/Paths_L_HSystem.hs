...
sysconfdir = "/home/Programming/Haskell/L-HSystem/.stack-work/install/x86_64-linux-ncurses6/lts-8.0/8.0.2/etc"

getBinDir, getLibDir, getDynLibDir, getDataDir, getLibexecDir, getSysconfDir :: IO FilePath
getBinDir = catchIO (getEnv "L_HSystem_bindir") (\_ -> return bindir)
getLibDir = catchIO (getEnv "L_HSystem_libdir") (\_ -> return libdir)
getDynLibDir = catchIO (getEnv "L_HSystem_dynlibdir") (\_ -> return dynlibdir)
getDataDir = catchIO (getEnv "L_HSystem_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "L_HSystem_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "L_HSystem_sysconfdir") (\_ -> return sysconfdir)
